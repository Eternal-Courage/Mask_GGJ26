...
UScriptStruct* Z_Construct_UScriptStruct_FWwiseGameParameterCookedData()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_WwiseGameParameterCookedData.InnerSingleton, Z_Construct_UScriptStruct_FWwiseGameParameterCookedData_Statics::StructParams);
	}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_CookedData_WwiseGameParameterCookedData_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWwiseGameParameterCookedData::StaticStruct, Z_Construct_UScriptStruct_FWwiseGameParameterCookedData_Statics::NewStructOps, TEXT("WwiseGameParameterCookedData"), &Z_Registration_Info_UScriptStruct_WwiseGameParameterCookedData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWwiseGameParameterCookedData), 3226983947U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_CookedData_WwiseGameParameterCookedData_h_714712681(TEXT("/Script/WwiseResourceLoader"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_CookedData_WwiseGameParameterCookedData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_CookedData_WwiseGameParameterCookedData_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
