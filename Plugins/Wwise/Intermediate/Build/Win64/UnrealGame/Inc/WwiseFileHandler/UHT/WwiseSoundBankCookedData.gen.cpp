...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWwiseSoundBankCookedData_Statics::NewProp_PackagedFile = { "PackagedFile", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWwiseSoundBankCookedData, PackagedFile), Z_Construct_UScriptStruct_FWwisePackagedFile, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PackagedFile_MetaData), NewProp_PackagedFile_MetaData) }; // 643790602
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWwiseSoundBankCookedData::StaticStruct, Z_Construct_UScriptStruct_FWwiseSoundBankCookedData_Statics::NewStructOps, TEXT("WwiseSoundBankCookedData"), &Z_Registration_Info_UScriptStruct_WwiseSoundBankCookedData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWwiseSoundBankCookedData), 4052698961U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_1207777626(TEXT("/Script/WwiseFileHandler"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Mask_GGJ26_Plugins_Wwise_Source_WwiseFileHandler_Public_Wwise_CookedData_WwiseSoundBankCookedData_h_Statics::EnumInfo));
// End Registration
