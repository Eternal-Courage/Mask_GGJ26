...
typedef enum AkAudioAPIAndroid
{
	...
	AkAudioAPI_Last,											   ///< End of enum, invalid value.
...
struct AkPlatformInitSettings
{
	...
	bool                bRoundFrameSizeToHWSize;///< (deprecated) Rounds the pipeline buffer size to a multiple of the hardware-preferred frame size.
												/// This setting is deprecated. This has no impact on performance and should be left to false (the default).
												/// The fast audio path can still be selected when this is false.
